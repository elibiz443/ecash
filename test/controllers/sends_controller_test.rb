...
class SendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create send" do
    assert_difference('Send.count') do
      post sends_url, params: { send: { amount: @send.amount, recipient_email: @send.recipient_email } }
    end
  ...
  test "should update send" do
    patch send_url(@send), params: { send: { amount: @send.amount, recipient_email: @send.recipient_email } }
